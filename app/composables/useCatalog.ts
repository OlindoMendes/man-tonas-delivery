...
const categories: Category[] = [
  ...
  { id: "cerveja", name: "Cervejas", icon: "/Icons8/birra.png" },
  { id: "cocktail", name: "Cocktails", icon: "/Icons8/cocktails.png" },
  { id: "destilados", name: "Destilados", icon: "/Icons8/vodka.png" },
];
...
const products: Product[] = [
  ...
  },
  {
    ...
    description: "Rum, hortelã e lima · 500ml",
    price: 4200,
    icon: "🍃",
    badgeClass: "bg-emerald-100",
    popular: true,
  },
  {
    id: "cocktail-02",
    categoryId: "cocktail",
    name: "Caipirinha de lima",
    description: "Cachaça, lima e açúcar · 500ml",
    price: 3900,
    icon: "🍋",
    badgeClass: "bg-lime-100",
  },
  {
    ...
    categoryId: "cocktail",
    name: "Margarita",
    description: "Tequila, triple sec e lima · 450ml",
    price: 5200,
    icon: "🍸",
    badgeClass: "bg-cyan-100",
  },
  {
    ...
    categoryId: "cocktail",
    name: "Piña colada",
    description: "Rum, coco e ananás · 500ml",
    price: 4800,
    icon: "🍍",
    badgeClass: "bg-yellow-100",
  },
  {
    ...
    categoryId: "cocktail",
    name: "Aperol spritz",
    description: "Aperol, prosecco e soda · 450ml",
    price: 5600,
    icon: "🍊",
    badgeClass: "bg-orange-100",
  },
  {
    ...
    categoryId: "cocktail",
    name: "Gin tropical",
    description: "Gin, tónica e fruta · 500ml",
    price: 6200,
    icon: "🌴",
    badgeClass: "bg-teal-100",
  },
  {
    ...
    categoryId: "cocktail",
    name: "Blue lagoon",
    description: "Vodka, curaçau e limonada · 450ml",
    price: 5100,
    icon: "🫧",
    badgeClass: "bg-blue-100",
  },
  ...
  },
  {
    id: "cocktail-10",
    categoryId: "cocktail",
    name: "Pack cocktails festa",
    description: "6 cocktails variados · 330ml",
    price: 19800,
    icon: "🎉",
    badgeClass: "bg-fuchsia-100",
  },
  ...
  },
  {
    id: "destilados-10",
    categoryId: "destilados",
    name: "Pack destilados premium",
    description: "3 garrafas selecionadas",
    price: 58900,
    icon: "🎁",
    badgeClass: "bg-purple-100",
  },
